/**
    ...
    Project Name: Dodge Ball For Survival
...
/**
    ...
    Email: mhossain173066@bscse.uiu.ac.bd
    ------------------------------------------------------------------------

    ------------------------------------------------------------------------
    Team Member 2
    Name: Ishmam Ahmed Alvi

    Id: 011163098 (United International University student Id)

    Email: iahmed163098@bscse.uiu.ac.bd
    ------------------------------------------------------------------------

    ------------------------------------------------------------------------
    Team Member 3
    Name: Asma Binte Abu Bakar

    Id: 011162153 (United International University student Id)

    Email: abakar162153@bscse.uiu.ac.bd
    ------------------------------------------------------------------------
    ...
    Id: 011163022 (United International University student Id)

    Email: tahmed163022@bscse.uiu.ac.bd
    ------------------------------------------------------------------------
*/

#include<bits/stdc++.h> ///The <bits/stdc++. h> is a header file. This file includes all standard library. ... For this header file, every time the compiler tries to import the headers recursively every time the code is compiled.
#include<windows.h> /// Windows.h is a Windows-specific header file for the C and C++ programming languages which contains declarations for all of the functions in the Windows API, all the common macros used by Windows programmers, and all the data types used by the various functions and subsystems
#include<GL/glut.h> /// The OpenGL Utility Toolkit (GLUT) is a library of utilities for OpenGL programs, which primarily perform system-level I/O with the host operating system.
...
int timerStart = 0, gameover = 0, elapsedTime = 0, col = 1, flag=0, flag1=0, ball_r=10, ball_r1=5, state, state1, score=0, lastscore=0, count = 0;
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("Dodge Ball By A6");
